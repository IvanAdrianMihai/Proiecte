...
/**
 * Write a description of class micdr2 here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class micdr2 extends mario
{
    /**
     * Act - do whatever the micdr2 wants to do. This method is called whenever
    ...
    public void act() 
    {
     ...
     if(this!=null&&this.isTouching(b3.class))
        {
            ...
            world.addObject(new maredr2(),x,y-8); 
        }
     else
     ...
     if(this!=null&&Greenfoot.isKeyDown("right")&&this.isTouching(pereti.class))
     {
       ...
       y=this.getY();
       world.removeObject(this);   
       world.addObject(new micdr3(),x,y);                     
     }
     else
        if(this!=null&&this.isTouching(pereti.class))
        {
