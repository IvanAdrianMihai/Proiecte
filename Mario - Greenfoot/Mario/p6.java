 ...
 */
public class p6 extends planta
{
    /**
     * Act - do whatever the p6 wants to do. This method is called whenever
    ...
    public void act() 
    {
        ...
        if(timp==3)
        {
            ...
            world.addObject(new p5(),x,y); 
            p5.distanta=distanta;
            p5.directie=directie;
            p5.timp2=timp2;
            p5.timp3=timp3;
        }
    }       
