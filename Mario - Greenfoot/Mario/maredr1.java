...
/**
 * Write a description of class maredr1 here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class maredr1 extends mario
{
    /**
     * Act - do whatever the maredr1 wants to do. This method is called whenever
    ...
    public void act() 
    {
     ...
     if(this!=null&&Greenfoot.isKeyDown("right")&&this.isTouching(pereti.class))
     {
         ...
         y=this.getY();
         world.removeObject(this);   
         world.addObject(new maredr2(),x,y);                     
     }
     else
     if(this!=null&&this.isTouching(pereti.class))
     {
