...
/**
 * Write a description of class micdr3 here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class micdr3 extends mario
{
    /**
     * Act - do whatever the micdr3 wants to do. This method is called whenever
    ...
    public void act() 
    {
     ...
     if(this!=null&&this.isTouching(b3.class))
        {
            ...
            world.addObject(new maredr3(),x,y-8); 
        }
     else
     ...
     if(this!=null&&!this.isTouching(pereti.class))
        {
            ...
            y=this.getY();
            world.removeObject(this);   
            world.addObject(new micdr4(),x,y);
        }
     else  
     ...
     if(this!=null&&Greenfoot.isKeyDown("right")&&this.isTouching(pereti.class))
     {
       ...
       y=this.getY();
       world.removeObject(this);   
       world.addObject(new micdr1(),x,y);                     
     }
     else
        if(this!=null&&this.isTouching(pereti.class))
        {
