...
/**
 * Write a description of class micdr1 here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class micdr1 extends mario
{
    /**
     * Act - do whatever the micdr1 wants to do. This method is called whenever
    ...
    public void act() 
    {
     ...
     if(this!=null&&this.isTouching(b3.class))
        {
            ...
            world.addObject(new maredr1(),x,y-8); 
        }
     else
     ...
     if(this!=null&&Greenfoot.isKeyDown("right")&&this.isTouching(pereti.class))
     {
       ...
       y=this.getY();
       world.removeObject(this);   
       world.addObject(new micdr2(),x,y);                     
     }
     else
     if(this!=null&&this.isTouching(pereti.class))
        {
