...
/**
 * Write a description of class md3 here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class md3 extends monstru
{
    /**
     * Act - do whatever the md3 wants to do. This method is called whenever
    ...
    public void act() 
    {
        ...
        {   
            ...
            world.addObject(new md4(),x,y);
            md4.distanta=distanta;
        }
        else
        if(this!=null&&x==623)
        {
