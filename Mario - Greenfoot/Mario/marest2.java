...
/**
 * Write a description of class marest2 here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class marest2 extends mario
{
    /**
     * Act - do whatever the marest2 wants to do. This method is called whenever
    ...
    public void act() 
    {
     ...
     if(this!=null&&Greenfoot.isKeyDown("left")&&this.isTouching(pereti.class))
     {
       ...
       y=this.getY();
       world.removeObject(this);   
       world.addObject(new marest3(),x,y);                     
     }
     else
     if(this!=null&&this.isTouching(pereti.class))
        {
