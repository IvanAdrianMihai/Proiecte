...
/**
 * Write a description of class ms2 here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class ms2 extends monstru
{
    /**
     * Act - do whatever the ms2 wants to do. This method is called whenever
    ...
    public void act() 
    {
        ...
        {   
            ...
            world.addObject(new ms3(),x,y);
            ms3.distanta=distanta;
        }
        else
        if(this!=null&&x==431)
        {
