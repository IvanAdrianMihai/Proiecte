...
/**
 * Write a description of class micst3 here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class micst3 extends mario
{
    /**
     * Act - do whatever the micst3 wants to do. This method is called whenever
     ...
     if(this!=null&&this.isTouching(b3.class))
        {
            ...
            world.addObject(new marest3(),x,y-8); 
        }
     else
