...
/**
 * Write a description of class sa1 here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class sa1 extends aripi
{
    /**
     * Act - do whatever the sa1 wants to do. This method is called whenever
    ...
    public void act() 
    {
        ...
        if(this!=null&&this.isTouching(pereti.class)&&distanta+1!=200)
        {
            ...
            World world=this.getWorld();
            world.removeObject(this);   
            world.addObject(new sa2(),x,y);
            sa2.distanta=distanta;
        }
        else
        if(this!=null&&this.isTouching(pereti.class)&&distanta+1==200)
        {
