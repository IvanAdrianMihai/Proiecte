 ...
 */
public class p4 extends planta
{
    /**
     * Act - do whatever the p4 wants to do. This method is called whenever
    ...
    public void act() 
    {
        ...
        if(timp==3)
        {
            ...
            world.addObject(new p3(),x,y); 
            p3.distanta=distanta;
            p3.directie=directie;
            p3.timp2=timp2;
            p3.timp3=timp3;
        }
    }       
