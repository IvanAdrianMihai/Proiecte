...
/**
 * Write a description of class micdr0 here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class micdr0 extends mario
{
    /**
     * Act - do whatever the micdr0 wants to do. This method is called whenever
    ...
    public void act() 
    {
        ...
        if(this!=null&&this.isTouching(b3.class))
        {
            ...
            world.addObject(new maredr0(),x,y-8); 
        }
        else
