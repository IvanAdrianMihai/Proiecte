...
/**
 * Write a description of class marest1 here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class marest1 extends mario
{
    /**
     * Act - do whatever the marest1 wants to do. This method is called whenever
    ...
    public void act() 
    {
     ...
     if(this!=null&&Greenfoot.isKeyDown("left")&&this.isTouching(pereti.class))
     {
       ...
       y=this.getY();
       world.removeObject(this);   
       world.addObject(new marest2(),x,y);                     
     }
     else
        if(this!=null&&this.isTouching(pereti.class))
        {
