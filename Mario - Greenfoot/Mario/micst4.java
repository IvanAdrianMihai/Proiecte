...
/**
 * Write a description of class micst4 here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class micst4 extends mario
{
    /**
     * Act - do whatever the micst4 wants to do. This method is called whenever
     ...
     if(this!=null&&this.isTouching(b3.class))
        {
            ...
            world.addObject(new marest4(),x,y-7); 
        }
     else
